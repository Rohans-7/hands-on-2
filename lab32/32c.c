...
/*
rohan-sonawane@rohan-sonawane-HP-Pavilion-Laptop-14-ce3xxx:~/handsOnLab2/lab32$ ./a.out
entering to obtain lock on the critical section
Obtained lock on critical section!
inside Critical section
ticket number is : 1	 
ticket number is stored in file
rohan-sonawane@rohan-sonawane-HP-Pavilion-Laptop-14-ce3xxx:~/handsOnLab2/lab32$  
