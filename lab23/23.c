...
/*
rohan-sonawane@rohan-sonawane-HP-Pavilion-Laptop-14-ce3xxx:~/handsOnLab2/lab23$ ./a.out
Maximum number of files that can be opened is: 1024
Maximum size of pipe: 4096
rohan-sonawane@rohan-sonawane-HP-Pavilion-Laptop-14-ce3xxx:~/handsOnLab2/lab23$  
*/
